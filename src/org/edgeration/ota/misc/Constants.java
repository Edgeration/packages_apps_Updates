 ...
 */
package org.edgeration.ota.misc;
...
public final class Constants {
    ...
    static final String PROP_DEVICE = "org.edgeration.device";
    static final String PROP_BUILD_VERSION = "ro.edgeration.version";
    static final String PROP_VERSION_CODE = "ro.edgeration.releasetype";
    static final String OTA_URL = "https://raw.githubusercontent.com/Edgeration/official_devices/master/builds/%s.json";
    static final String DOWNLOAD_WEBPAGE_URL = "https://raw.githubusercontent.com/Edgeration/official_devices/master/changelogs/%s/%s.txt";
    public static final String DOWNLOAD_PATH = "/data/edgeration_updates/";
    static final String EXPORT_PATH = "EdgeRation-Updates/";
